...
'''I have created this project using Twilio(A cloud communication service),Ngrok and flask.We start the project by creating a virtual environment.With the help of twilio we create a sandbox (for testing our bot).Twilio provides us a number and 
